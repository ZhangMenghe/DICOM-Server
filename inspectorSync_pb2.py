...
VPMsg = _reflection.GeneratedProtocolMessageType('VPMsg', (_message.Message,), {
  'DESCRIPTOR' : _VPMSG,
...
GestureOp = _reflection.GeneratedProtocolMessageType('GestureOp', (_message.Message,), {
...
OperationBatch = _reflection.GeneratedProtocolMessageType('OperationBatch', (_message.Message,), {
...
ResetMsg = _reflection.GeneratedProtocolMessageType('ResetMsg', (_message.Message,), {
...
TuneMsg = _reflection.GeneratedProtocolMessageType('TuneMsg', (_message.Message,), {
  'DESCRIPTOR' : _TUNEMSG,
  '__module__' : 'inspectorSync_pb2'
...
CheckMsg = _reflection.GeneratedProtocolMessageType('CheckMsg', (_message.Message,), {
...
MaskMsg = _reflection.GeneratedProtocolMessageType('MaskMsg', (_message.Message,), {
  'DESCRIPTOR' : _MASKMSG,
  '__module__' : 'inspectorSync_pb2'
...
FrameUpdateMsg = _reflection.GeneratedProtocolMessageType('FrameUpdateMsg', (_message.Message,), {
