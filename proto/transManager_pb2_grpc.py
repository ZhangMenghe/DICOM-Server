...
from proto import transManager_pb2 as proto_dot_transManager__pb2
...
class dataTransferStub(object):
  ...
  def __init__(self, channel):
    ...
    self.getAvailableConfigs = channel.unary_unary(
        ...
        request_serializer=proto_dot_transManager__pb2.Request.SerializeToString,
        response_deserializer=proto_dot_transManager__pb2.configResponse.FromString,
        )
    self.exportConfigs = channel.unary_unary(
        '/helmsley.dataTransfer/exportConfigs',
        request_serializer=proto_dot_transManager__pb2.Request.SerializeToString,
        response_deserializer=proto_dot_transManager__pb2.Response.FromString,
        )
    self.getAvailableDatasets = channel.unary_unary(
        '/helmsley.dataTransfer/getAvailableDatasets',
        request_serializer=proto_dot_transManager__pb2.Request.SerializeToString,
        response_deserializer=proto_dot_transManager__pb2.datasetResponse.FromString,
        )
    self.getVolumeFromDataset = channel.unary_stream(
        '/helmsley.dataTransfer/getVolumeFromDataset',
        request_serializer=proto_dot_transManager__pb2.Request.SerializeToString,
        response_deserializer=proto_dot_transManager__pb2.volumeResponse.FromString,
        )
    self.Download = channel.unary_stream(
        '/helmsley.dataTransfer/Download',
        request_serializer=proto_dot_transManager__pb2.Request.SerializeToString,
        response_deserializer=proto_dot_transManager__pb2.dcmImage.FromString,
        )
    self.DownloadVolume = channel.unary_stream(
        '/helmsley.dataTransfer/DownloadVolume',
        request_serializer=proto_dot_transManager__pb2.RequestWholeVolume.SerializeToString,
        response_deserializer=proto_dot_transManager__pb2.volumeWholeResponse.FromString,
        )
...
def add_dataTransferServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'getAvailableConfigs': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=proto_dot_transManager__pb2.Request.FromString,
          response_serializer=proto_dot_transManager__pb2.configResponse.SerializeToString,
      ),
      'exportConfigs': grpc.unary_unary_rpc_method_handler(
          servicer.exportConfigs,
          request_deserializer=proto_dot_transManager__pb2.Request.FromString,
          response_serializer=proto_dot_transManager__pb2.Response.SerializeToString,
      ),
      'getAvailableDatasets': grpc.unary_unary_rpc_method_handler(
          servicer.getAvailableDatasets,
          request_deserializer=proto_dot_transManager__pb2.Request.FromString,
          response_serializer=proto_dot_transManager__pb2.datasetResponse.SerializeToString,
      ),
      'getVolumeFromDataset': grpc.unary_stream_rpc_method_handler(
          servicer.getVolumeFromDataset,
          request_deserializer=proto_dot_transManager__pb2.Request.FromString,
          response_serializer=proto_dot_transManager__pb2.volumeResponse.SerializeToString,
      ),
      'Download': grpc.unary_stream_rpc_method_handler(
          servicer.Download,
          request_deserializer=proto_dot_transManager__pb2.Request.FromString,
          response_serializer=proto_dot_transManager__pb2.dcmImage.SerializeToString,
      ),
      'DownloadVolume': grpc.unary_stream_rpc_method_handler(
          servicer.DownloadVolume,
          request_deserializer=proto_dot_transManager__pb2.RequestWholeVolume.FromString,
          response_serializer=proto_dot_transManager__pb2.volumeWholeResponse.SerializeToString,
      ),
